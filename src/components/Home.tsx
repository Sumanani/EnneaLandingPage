...
const Home = () => {
  return (
    <div className="px-8 md:px-10 h-screen bg-gradient-to-b from-[#c4f0fe] to-transparent flex justify-center">
      <div className="container my-8 grid grid-cols-1 md:grid-cols-2 place-items-center gap-2">
